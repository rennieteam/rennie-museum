<?php
/**
 * rennie museum: Color Patterns
 *
 * @package WordPress
 * @subpackage renniemuseum
 * @since 1.0
 */
 ...
 */
function renniemuseum_custom_colors_css() {
	...
	/**
	 * Filter rennie museum default saturation level.
	 *
	 * @since rennie museum 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'renniemuseum_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter rennie museum default selection saturation level.
	 *
	 * @since rennie museum 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'renniemuseum_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter rennie museum default lightness level.
	 *
	 * @since rennie museum 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'renniemuseum_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter rennie museum default hover lightness level.
	 *
	 * @since rennie museum 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'renniemuseum_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter rennie museum default selection lightness level.
	 *
	 * @since rennie museum 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'renniemuseum_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters rennie museum custom colors CSS.
	 *
	 * @since rennie museum 1.0
	 *
	 ...
	 */
	return apply_filters( 'renniemuseum_custom_colors_css', $theme_css, $primary_color, $saturation );
}
